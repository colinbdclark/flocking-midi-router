...
fluid.defaults("flock.midi.router.launcher", {
    ...
    yargsOptions: {
        describe: {
            "listPorts":  "List the available MIDI inputs and outputs.",
            "inputs":     "A space-delimited array of inputs.",
            "outputs":    "A space-delimited array of outputs.",
            "setLogging": "The Fluid log level to use (false by default)."
        },
        defaults: {
            optionsFile: "%flocking-midi-router/configs/base.json"
        },
        array: ["inputs", "outputs"], // TODO: Confirm this works
        boolean: "listPorts",
        alias: {
            "listPorts": ["l", "list-ports"],
            "inputs":    "i",
            "outputs":   "o"
        },
